...
namespace DealPLC
{
    ...
    /// 数据寄存器6
    /// </summary>
    public class RegData6 : BaseRegPLC
    {
        #region 静态类实例
        public static RegData6 R_I = new RegData6();
        #endregion 静态类实例
        ...
        public RegData6()
        {
            base.NameClass = "RegData6";

            //ini存储地址
            base.PathRegIni = ParPathRoot.PathRoot + "Store\\PLC\\RegData6.ini";
        }
