...
namespace DealPLC
{
    ...
    /// 数据寄存器2
    /// </summary>
    public class RegData2 : BaseRegPLC
    {
        #region 静态类实例
        public static RegData2 R_I = new RegData2();
        #endregion 静态类实例
        ...
        public RegData2()
        {
            base.NameClass = "RegData2";

            //ini存储地址
            base.PathRegIni = ParPathRoot.PathRoot + "Store\\PLC\\RegData2.ini";
        }
