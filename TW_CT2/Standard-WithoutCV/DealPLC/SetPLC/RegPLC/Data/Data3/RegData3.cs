...
namespace DealPLC
{
    ...
    /// 数据寄存器3
    /// </summary>
    public class RegData3 : BaseRegPLC
    {
        #region 静态类实例
        public static RegData3 R_I = new RegData3();
        #endregion 静态类实例
        ...
        public RegData3()
        {
            base.NameClass = "RegData3";

            //ini存储地址
            base.PathRegIni = ParPathRoot.PathRoot + "Store\\PLC\\RegData3.ini";
        }
