...
namespace DealPLC
{
    public class RegData5 : BaseRegPLC
    {
        #region 静态类实例
        public static RegData5 R_I = new RegData5();
        #endregion 静态类实例
        ...
        public RegData5()
        {
            base.NameClass = "RegData5";

            //ini存储地址
            base.PathRegIni = ParPathRoot.PathRoot + "Store\\PLC\\RegData5.ini";
        }
