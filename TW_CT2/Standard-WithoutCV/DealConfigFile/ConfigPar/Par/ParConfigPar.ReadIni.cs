...
namespace DealConfigFile
{
    partial class ParConfigPar
    {
        ...
        bool BlReadAdj = false;//是否读取调整值配置
        #endregion 定义
        ...
        public bool ReadIniConfigPar()
        {
            ...
            {               
                ...
                new Task(new Action(()=>
                {
                    ...
                    {
                        BlReadAdj = true;
                        ParSetAdjust.P_I.ReadIniAdj();//读取调整值
                        ParSetAdjust.P_I.ReadIniStd();//读取基准值
                        ParSetAdjust.P_I.ReadIniRptStd();
                        ParSetAdjust.P_I.ReadIniRptAdj();
                    }
        ...
        public bool ReadIniParProduct()
        {
            ...
            {                
                ...
                ComConfigPar.C_I.BlUsingNo = I_I.ReadIniBl("Model", "BlUsingNo", ComConfigPar.C_I.PathConfigIni);

                ComConfigPar.C_I.NameModel = I_I.ReadIniStr("Model", "Name", ComConfigPar.C_I.PathConfigIni);
                ComConfigPar.C_I.NoConfig = I_I.ReadIniInt("Model", "NoConfig", ComConfigPar.C_I.PathConfigIni);

                //是否显示列表序号
                this.BlShowNo = I_I.ReadIniBl("Model", "BlShowNo", true, ComConfigPar.C_I.PathConfigIni);
