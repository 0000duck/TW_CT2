    ...
    public partial class ParConfigPar
    {
        ...
        public bool WriteIniParProduct()
        {
            try
            {
                ...
                sw.Start();
                //配置文件名称
                I_I.WriteIni("Model", "BlUsingNo", ComConfigPar.C_I.BlUsingNo, ComConfigPar.C_I.PathConfigIni);

                I_I.WriteIni("Model", "Name", ComConfigPar.C_I.NameModel, ComConfigPar.C_I.PathConfigIni);
                I_I.WriteIni("Model", "NoConfig", ComConfigPar.C_I.NoConfig, ComConfigPar.C_I.PathConfigIni);

                //配置文件序号
                I_I.WriteIni("Model", "No", this.No.ToString(), ComConfigPar.C_I.PathConfigIni);

                //是否显示列表序号
                I_I.WriteIni("Model", "BlShowNo", this.BlShowNo.ToString(), ComConfigPar.C_I.PathConfigIni);
