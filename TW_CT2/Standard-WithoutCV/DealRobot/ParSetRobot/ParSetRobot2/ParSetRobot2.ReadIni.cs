...
namespace DealRobot
{
    partial class ParSetRobot2
    {
        ...
        public bool ReadTypeRobot()
        {
            ...
            {
                //读取机器人类型
                string type = IniFile.I_I.ReadIniStr("DealRobot", "Type", "Null", ParSetRobot2.c_PathTypeRobot);
                ParSetRobot2.P_I.TypeRobot_e = (TypeRobot_enum)(Enum.Parse(typeof(TypeRobot_enum), type));
                //是否自动连接通信
                BlAutoConnect = IniFile.I_I.ReadIniBl("DealRobot", "BlAutoConnect", false, ParSetRobot2.c_PathTypeRobot);
