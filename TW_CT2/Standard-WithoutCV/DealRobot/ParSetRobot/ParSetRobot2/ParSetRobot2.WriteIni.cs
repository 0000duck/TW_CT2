...
namespace DealRobot
{
    partial class ParSetRobot2
    {
        ...
        public bool WriteTypeRobot()
        {
            try
            {
                IniFile.I_I.WriteIni("DealRobot", "Type", ParSetRobot2.P_I.TypeRobot_e.ToString(), ParSetRobot2.c_PathTypeRobot);
                IniFile.I_I.WriteIni("DealRobot", "BlAutoConnect", ParSetRobot2.P_I.BlAutoConnect.ToString(), ParSetRobot2.c_PathTypeRobot);
           
                return true;
            }
            catch (Exception ex)
            {
                Log.L_I.WriteError("ParSetRobot2", ex);
                return false;
            }
        }
        #endregion 机器人类型
